...
if (typeof window !== 'undefined') {
  ...
  window.addEventListener('testPassive', null, passiveTestOption); // @ts-ignore compatible passive

  window.removeEventListener('testPassive', null, passiveTestOption);
}

var preventDefault = function preventDefault(event) {
  var e = event || window.event; // If more than one touch we don't prevent
...
var ScrollLocker = function ScrollLocker(options) {
  ...
  this.lock = function () {
    ...
    if (!scrollingEffectClassNameReg.test(containerClassName)) {
      ...
      document.addEventListener('touchmove', preventDefault, passiveSupported ? {
        passive: false
      } : undefined);
    }
  ...
  this.unLock = function () {
    ...
    container.className = container.className.replace(scrollingEffectClassNameReg, '').trim(); // @ts-ignore compatible passive

    document.removeEventListener('touchmove', preventDefault, passiveSupported ? {
      passive: false
    } : undefined);
