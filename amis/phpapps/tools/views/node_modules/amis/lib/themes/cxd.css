...
@media (min-width: 768px) {
  ...
  .cxd-Layout-header, .cxd-Layout-footer {
    width: 100%;
  }
...
.cxd-Button {
  ...
  white-space: nowrap;
  min-width: 4.25rem;
  padding: 0.3392857143rem 0.625rem;
  font-size: 0.75rem;
...
.cxd-Button--secondary:hover {
  color: #fff;
  background-color: #5a6268;
  border-color: #545b62;
}
.cxd-Button--secondary:focus {
  color: #fff;
  background-color: #6c757d;
  border-color: #6c757d;
  box-shadow: none;
...
.cxd-Button--success:hover {
  color: #fff;
  background-color: #4f952b;
  border-color: #4a8b28;
}
.cxd-Button--success:focus {
  color: #fff;
  background-color: #5fb333;
  border-color: #5fb333;
  box-shadow: none;
...
.cxd-Button--info:hover {
  color: #fff;
  background-color: #0e77ca;
  border-color: #0d70be;
}
.cxd-Button--info:focus {
  color: #fff;
  background-color: #108cee;
  border-color: #108cee;
  box-shadow: none;
...
.cxd-Button--warning:hover {
  color: #fff;
  background-color: #cd7900;
  border-color: #c07200;
}
.cxd-Button--warning:focus {
  color: #fff;
  background-color: #f39000;
  border-color: #f39000;
  box-shadow: none;
...
.cxd-Button--danger:hover {
  color: #fff;
  background-color: #f64545;
  border-color: #d01515;
}
.cxd-Button--danger:focus {
  color: #fff;
  background-color: #ea2e2e;
  border-color: #ea2e2e;
  box-shadow: none;
...
.cxd-Button--light:hover {
  color: #666;
  background-color: #c5e6fc;
  border-color: #c7d0ea;
}
.cxd-Button--light:focus {
  color: #666;
  background-color: #eaf6fe;
  border-color: #eceff8;
  box-shadow: none;
...
.cxd-Button--dark:hover {
  color: #fff;
  background-color: #23272b;
  border-color: #1d2124;
}
.cxd-Button--dark:focus {
  color: #fff;
  background-color: #343a40;
  border-color: #343a40;
  box-shadow: none;
...
.cxd-Button--default:hover {
  color: #108cee;
  background-color: #fff;
  border-color: #108cee;
}
.cxd-Button--default:focus {
  color: #000;
  background-color: #fff;
  border-color: #cccccc;
  box-shadow: none;
...
.cxd-ButtonToolbar > .cxd-Button--disabled-wrap > .cxd-Button {
  margin-left: 0.3125rem;
  margin-top: 0.3125rem;
}
...
.cxd-ArrayInput-addBtn:hover {
  color: #fff;
  background-color: #0e77ca;
  border-color: #0d70be;
}
.cxd-ArrayInput-addBtn:focus {
  color: #fff;
  background-color: #108cee;
  border-color: #108cee;
  box-shadow: none;
...
.cxd-ArrayInput-addBtn.is-disabled, .cxd-ArrayInput-addBtn:disabled {
  background-color: #f5f5f5;
  color: #aaa;
  border-color: #ebebeb;
}
...
.cxd-ArrayInput-itemRemove, .cxd-ArrayInput-itemDrager {
  ...
  flex-grow: unset;
  display: inline-block;
  padding: 0.4017857143rem 0.3125rem;
  cursor: pointer;
}
...
.cxd-Nav--tabs .cxd-Nav-item.disabled > a, .cxd-Nav--tabs .cxd-Nav-item.is-disabled > a {
  color: #6c757d;
  background-color: transparent;
  border-color: transparent;
  pointer-events: none;
}
.cxd-Nav--tabs .cxd-Nav-item.active > a, .cxd-Nav--tabs .cxd-Nav-item.is-active > a {
  color: #495057;
  background-color: #fff;
  border-color: #dee2e6;
  border-bottom-color: #fff;
...
.cxd-Nav--stacked .cxd-Nav-item .cxd-Nav-item.active > a:before, .cxd-Nav--stacked .cxd-Nav-item .cxd-Nav-item.is-active > a:before {
  background-color: #108cee;
}
...
.cxd-CBGroup-toolbar:not(:hover) .cxd-CBGroup-toolbarLeft .cxd-Button:not(.is-active) {
  width: 0;
  padding: 0;
  overflow: hidden;
  opacity: 0;
...
.cxd-CBGroup-toolbar .cxd-CBGroup-toolbarRight {
  transition: opacity 0.2s;
  display: flex;
  align-items: center;
}
.cxd-CBGroup-toolbar .cxd-CBGroup-toolbarRight .cxd-CBDelete {
  margin-left: 0.3125rem;
}
.cxd-CBGroup-toolbar:not(:hover) .cxd-CBGroup-toolbarRight {
  opacity: 0;
}
...
@media (min-width: 576px) {
  ...
  .cxd-Crud-actions > .cxd-Button + .cxd-Button {
    margin-left: 0.625rem;
  }
}
.cxd-Table {
...
.cxd-Table-fixedTop > .cxd-Table-heading {
  border-bottom: none;
}
...
.cxd-Table-header + .cxd-Table-contentWrap, .cxd-Table-toolbar + .cxd-Table-contentWrap {
  border-top: 0.0625rem solid #f5f5f5;
}
...
.cxd-Image-thumb:hover .cxd-Image-overlay {
  display: flex;
}
...
.cxd-ImageField::before, .cxd-ImageField::after {
  display: table;
  content: "";
}
.cxd-ImageField::after {
  clear: both;
}
...
.cxd-ListMenu-groupLabel {
  font-size: 0.6875rem;
  color: #999;
  padding: 0.0892857143rem 0 0 0.3125rem;
}
...
.cxd-ListMenu-item {
  ...
  font-size: 0.75rem;
  cursor: pointer;
  padding: 0.4017857143rem 0.625rem;
}
...
.cxd-TextControl-sugItem {
  padding: 0.3392857143rem 0.75rem;
}
...
.cxd-TextareaControl {
  ...
  line-height: 1.4285714286;
  background: #fff;
  padding: 0.375rem 0.6785714286rem;
  font-size: 0.75rem;
  outline: none;
  resize: none;
  display: block;
...
.cxd-Checkboxes > .cxd-Checkbox {
  ...
  line-height: 1.4285714286;
  font-size: 0.75rem;
  padding: 0.4017857143rem 0.625rem 0.4017857143rem 1.5rem;
}
...
.cxd-TreeCheckboxes-itemInner:hover,
.cxd-TreeRadios-itemInner:hover {
  background-color: rgba(0, 126, 255, 0.08);
}
...
.cxd-Select {
  ...
  border-radius: 0;
  min-height: 1.875rem;
  padding: 0.3392857143rem 0 0.3392857143rem 0.625rem;
  cursor: pointer;
  color: #000;
}
.cxd-Select:hover {
...
.cxd-Select-option {
  cursor: pointer;
  min-width: 7.5rem;
  padding: 0.2142857143rem 0.625rem;
}
...
.cxd-ImageControl-addBtn:hover {
  color: #108cee;
  background-color: #fff;
  border-color: #108cee;
}
.cxd-ImageControl-addBtn:focus {
  color: #666;
  background-color: #fff;
  border-color: 0.0625rem solid #dbdbdb;
  box-shadow: none;
...
.cxd-Tree-itemInput > input {
  ...
  border-radius: 0;
  line-height: 1.4285714286;
  padding: 0.1986607143rem 0.625rem;
  font-size: 0.75rem;
}
...
.cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel, .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-placeholder {
  padding-left: 1.25rem;
}
.cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel, .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-placeholder {
  padding-left: 2.5rem;
}
.cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel {
  padding-left: 3.75rem;
}
.cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel {
  padding-left: 5rem;
}
.cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel {
  padding-left: 6.25rem;
}
.cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel {
  padding-left: 7.5rem;
}
.cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel {
  padding-left: 8.75rem;
}
.cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel {
  padding-left: 10rem;
}
.cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel {
  padding-left: 11.25rem;
}
.cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item .cxd-Tree-item > .cxd-Tree-itemLabel {
...
.cxd-Combo-addBtn:hover {
  color: #fff;
  background-color: #0e77ca;
  border-color: #0d70be;
}
.cxd-Combo-addBtn:focus {
  color: #fff;
  background-color: #108cee;
  border-color: #108cee;
  box-shadow: none;
...
.cxd-Combo--hor .cxd-Combo-itemDrager {
  padding: 0.3125rem 0.375rem 0 0;
}
...
.cxd-Combo--ver:not(.cxd-Combo--noBorder):not(.is-disabled) > .cxd-Combo-item:hover > .cxd-Combo-itemToolbar, .cxd-Combo--ver:not(.cxd-Combo--noBorder):not(.is-disabled) > .cxd-Combo-items > .cxd-Combo-item:hover > .cxd-Combo-itemToolbar {
  top: -1.5625rem;
  opacity: 1;
}
...
.cxd-SubForm-addBtn > svg.icon:not(:last-child):not(.pull-right),
...
.cxd-SubForm-addBtn:hover {
  color: #fff;
  background-color: #0e77ca;
  border-color: #0d70be;
}
.cxd-SubForm-addBtn:focus {
  color: #fff;
  background-color: #108cee;
  border-color: #108cee;
  box-shadow: none;
...
.cxd-TagControl-sugItem:hover {
  color: #000;
  background-color: #ececec;
  border-color: #b3b3b3;
}
.cxd-TagControl-sugItem:focus {
  color: #000;
  background-color: #fff;
  border-color: #cccccc;
  box-shadow: none;
...
.cxd-NestedSelect.is-opened .cxd-Select-arrow > svg {
  transform: rotate(180deg);
}
.cxd-NestedSelect:not(.is-disabled):hover {
  background: #fff;
}
.cxd-NestedSelect--multi .cxd-Select-value {
  position: static;
  user-select: none;
  line-height: 0.9464285714rem;
  display: inline-block;
...
.cxd-NestedSelect--multi .cxd-Select-valueLabel {
  padding: 0 0.3125rem;
}
...
.cxd-NestedSelect-menu .cxd-NestedSelect-option > .cxd-NestedSelect-optionLabel span {
  display: inline-flex;
  word-break: break-all;
}
...
@media (min-width: 576px) {
  .cxd-Form-control--sizeXs > .cxd-NestedSelect,
.cxd-Form-control--sizeSm > .cxd-NestedSelect,
.cxd-Form-control--sizeMd > .cxd-NestedSelect,
.cxd-Form-control--sizeLg > .cxd-NestedSelect {
    display: inline-flex !important;
  }
}
...
.cxd-Form--inline > .cxd-PlainField {
  display: inline-block;
  padding-top: 0.3392857143rem;
}

.cxd-Form-static {
  min-height: 1.875rem;
  padding-top: 0.4017857143rem;
  padding-bottom: 0.4017857143rem;
  margin-bottom: 0;
}
...
@media (min-width: 576px) {
  ...
  .cxd-Form-control--sizeXs.cxd-TextareaControl {
    width: auto;
  }
  ...
  .cxd-Form-control--sizeSm.cxd-TextareaControl {
    width: auto;
  }
  ...
  .cxd-Form-control--sizeMd.cxd-TextareaControl {
    width: auto;
  }
  ...
  .cxd-Form-control--sizeLg.cxd-TextareaControl {
    width: auto;
  }
...
.cxd-Form-item--horizontal .cxd-Form-itemColumn--lg {
  ...
  .cxd-Form-item--inline .cxd-TextControl {
    width: 12.5rem;
  }
...
.text-shadow {
  font-size: 170px;
  text-shadow: 0 1px 0 #eceff8, 0 2px 0 white, 0 5px 10px rgba(0, 0, 0, 0.125), 0 10px 20px rgba(0, 0, 0, 0.2);
}
