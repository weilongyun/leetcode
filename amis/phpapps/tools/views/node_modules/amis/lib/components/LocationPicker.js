...
var BaiduMapPicker_1 = tslib_1.__importDefault(require("./BaiduMapPicker"));
...
var LocationPicker = /** @class */ (function (_super) {
    ...
    LocationPicker.prototype.handleChange = function (value) {
        if (value) {
            value = tslib_1.__assign(tslib_1.__assign({}, value), { vendor: this.props.vendor });
        }
        this.props.onChange(value);
    };
    LocationPicker.prototype.render = function () {
        var _a;
        var _b = this.props, cx = _b.classnames, value = _b.value, className = _b.className, disabled = _b.disabled, placeholder = _b.placeholder, clearable = _b.clearable, popOverContainer = _b.popOverContainer, vendor = _b.vendor, ak = _b.ak;
        ...
        return (react_1.default.createElement("div", { tabIndex: 0, onKeyPress: this.handleKeyPress, onFocus: this.handleFocus, onBlur: this.handleBlur, className: cx("LocationPicker", {
            ...
            react_1.default.createElement(Overlay_1.default, { target: this.getTarget, container: popOverContainer || this.getParent, rootClose: false, show: isOpened },
                react_1.default.createElement(PopOver_1.default, { className: cx('LocationPicker-popover'), onHide: this.close, overlay: true, onClick: this.handlePopOverClick, style: { width: (_a = this.getTarget()) === null || _a === void 0 ? void 0 : _a.offsetWidth } }, vendor === 'baidu' ? (react_1.default.createElement(BaiduMapPicker_1.default, { ak: ak, value: value, onChange: this.handleChange })) : (react_1.default.createElement(Alert2_1.default, null, __('${vendor} 地图控件不支持', { vendor: vendor })))))));
    };
    var _a, _b, _c;
...
var ThemedCity = theme_1.themeable(locale_1.localeable(LocationPicker));
