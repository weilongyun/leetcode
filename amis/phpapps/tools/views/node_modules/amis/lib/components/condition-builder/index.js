...
var Animation_1 = tslib_1.__importDefault(require("../../utils/Animation"));
var QueryBuilder = /** @class */ (function (_super) {
    tslib_1.__extends(QueryBuilder, _super);
    function QueryBuilder() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.config = tslib_1.__assign(tslib_1.__assign({}, config_1.default), _this.props.config);
        _this.lastMoveAt = 0;
        return _this;
    }
    ...
    QueryBuilder.prototype.handleDragDrop = function () {
        ...
        var indexes = helper_1.findTreeIndex([value], function (item) { return item.id === fromId; });
        if (indexes) {
            var origin = helper_1.getTree([value], indexes.concat());
            value = helper_1.spliceTree([value], indexes, 1)[0];
            var indexes2 = helper_1.findTreeIndex([value], function (item) { return item.id === toId; });
            if (indexes2) {
                value = helper_1.spliceTree([value], indexes2.concat(toIndex), 0, origin)[0];
                onChange(value);
            }
        }
    };
    ...
    QueryBuilder.prototype.render = function () {
        var _a = this.props, cx = _a.classnames, fields = _a.fields, funcs = _a.funcs, onChange = _a.onChange, value = _a.value, showNot = _a.showNot;
        var normalizedValue = Array.isArray(value === null || value === void 0 ? void 0 : value.children)
            ? tslib_1.__assign(tslib_1.__assign({}, value), { children: helper_1.mapTree(value.children, function (value) {
                    if (value.id) {
                        return value;
                    }
                    return tslib_1.__assign(tslib_1.__assign({}, value), { id: helper_1.guid() });
                }) }) : value;
        return (react_1.default.createElement(Group_1.default, { config: this.config, funcs: funcs || this.config.funcs, fields: fields || this.config.fields, value: normalizedValue, onChange: onChange, classnames: cx, removeable: false, onDragStart: this.handleDragStart, showNot: showNot }));
    };
    var _a, _b, _c;
    tslib_1.__decorate([
        helper_1.autobind,
