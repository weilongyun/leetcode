...
var TableCheckboxes = /** @class */ (function (_super) {
    tslib_1.__extends(TableCheckboxes, _super);
    ...
    TableCheckboxes.defaultProps = tslib_1.__assign(tslib_1.__assign({}, Checkboxes_1.BaseCheckboxes.defaultProps), { cellRender: function (column, option, colIndex, rowIndex) { return react_1.default.createElement("span", null, tpl_builtin_1.resolveVariable(column.name, option)); } });
