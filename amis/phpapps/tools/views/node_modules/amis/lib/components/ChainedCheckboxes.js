...
var ChainedCheckboxes = /** @class */ (function (_super) {
    tslib_1.__extends(ChainedCheckboxes, _super);
    ...
    ChainedCheckboxes.prototype.render = function () {
        ...
        if (Array.isArray(options) && options.length) {
            ...
            var depth = Math.min(helper_1.getTreeDepth(options), 3);
            times_1.default(Math.max(depth - selected_1.length, 1), function () { return selected_1.push(null); });
