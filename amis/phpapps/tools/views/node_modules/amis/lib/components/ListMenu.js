...
var ListMenu = /** @class */ (function (_super) {
    tslib_1.__extends(ListMenu, _super);
    function ListMenu() {
    ...
    ListMenu.prototype.renderItem = function (result, option, optionIndex) {
        ...
        result.items.push(react_1.default.createElement("div", tslib_1.__assign({ className: cx('ListMenu-item', option.className, disabled || option.disabled ? 'is-disabled' : '', index === highlightIndex ? 'is-highlight' : '', ~(selectedOptions || []).indexOf(option) ? 'is-active' : ''), key: index, onClick: onSelect ? function (e) { return onSelect(e, option); } : undefined }, getItemProps({
            item: option,
            index: index
        })),
