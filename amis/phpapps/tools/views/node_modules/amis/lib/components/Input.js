...
var InputInner = /** @class */ (function (_super) {
    ...
    InputInner.prototype.render = function () {
        ...
        return (react_1.default.createElement("input", tslib_1.__assign({ type: "text" }, rest, { value: this.state.value, ref: forwardedRef, onChange: this.handleChange, onCompositionStart: this.handleComposition, onCompositionUpdate: this.handleComposition, onCompositionEnd: this.handleComposition })));
    };
    var _a, _b;
    tslib_1.__decorate([
        helper_1.autobind,
