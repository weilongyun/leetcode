...
var Range = /** @class */ (function (_super) {
    ...
    Range.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_input_range_1.default, tslib_1.__assign({}, this.props, { classNames: classNames, minValue: min, maxValue: max, value: value })));
    };
    Range.defaultProps = {
        min: 1,
        max: 100
