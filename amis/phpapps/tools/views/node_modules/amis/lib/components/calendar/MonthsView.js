...
// @ts-ignore
var MonthsView_1 = tslib_1.__importDefault(require("react-datetime/src/MonthsView"));
...
var CustomMonthsView = /** @class */ (function (_super) {
    ...
    CustomMonthsView.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: "rdtMonths" },
            react_1.default.createElement("table", null, showYearHead && (react_1.default.createElement("thead", null,
                react_1.default.createElement("tr", null,
                    react_1.default.createElement("th", { className: "rdtPrev", onClick: this.props.subtractTime(1, 'years') }, "\u00AB"),
                    canClick ? (react_1.default.createElement("th", { className: "rdtSwitch", onClick: this.props.showView('years') }, this.props.viewDate.format(__('YYYY年')))) : (react_1.default.createElement("th", { className: "rdtSwitch" }, this.props.viewDate.format(__('YYYY年')))),
