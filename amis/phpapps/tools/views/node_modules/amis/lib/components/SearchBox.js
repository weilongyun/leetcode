...
var SearchBox = /** @class */ (function (_super) {
    ...
    SearchBox.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: cx('SearchBox', disabled ? 'is-disabled' : '', !mini || active ? 'is-active' : '') },
            react_1.default.createElement("input", { name: name, disabled: disabled, onChange: this.handleChange, value: value || '', placeholder: __(placeholder || '输入关键字'), ref: this.inputRef, autoComplete: "off", onKeyDown: this.handleKeyDown }),
