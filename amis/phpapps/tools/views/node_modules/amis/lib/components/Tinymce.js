...
var TinymceEditor = /** @class */ (function (_super) {
    tslib_1.__extends(TinymceEditor, _super);
    ...
    TinymceEditor.prototype.componentDidMount = function () {
        ...
        this.config = tslib_1.__assign(tslib_1.__assign({ inline: false, skin: false, content_css: false, height: 400, language: !locale || locale === 'zh-cn' ? 'zh_CN' : 'en', plugins: [
