...
var Cards = /** @class */ (function (_super) {
    ...
    Cards.prototype.renderHeader = function () {
        ...
        var toolbarNode = actions || child || store.dragging ? (react_1.default.createElement("div", { className: cx('Cards-toolbar'), key: "header-toolbar" },
            actions,
            child,
            store.dragging ? (react_1.default.createElement("div", { className: cx('Cards-dragTip'), ref: this.dragTipRef }, __('请拖动顶部的按钮进行排序'))) : null)) : null;
    ...
    Cards.prototype.renderDragToggler = function () {
        ...
        return (react_1.default.createElement(Button_1.default, { iconOnly: true, key: "dragging-toggle", tooltip: __('对卡片进行排序操作'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, size: "sm", active: store.dragging, onClick: function (e) {
                e.preventDefault();
