    ...
    ListItem.prototype.renderRight = function () {
        ...
        if (Array.isArray(actions)) {
            return (react_1.default.createElement("div", { className: cx('ListItem-actions') }, actions.map(function (action, index) {
                ...
                return render("action/" + index, tslib_1.__assign({ size: 'sm', level: 'link', type: 'button' }, action // todo 等后面修复了干掉 https://github.com/microsoft/TypeScript/pull/38577
                ), {
                    key: index,
    ...
    ListItem.prototype.renderBody = function () {
        ...
        if (!body) {
            ...
            return body.map(function (child, index) {
                return _this.renderChild(tslib_1.__assign({ type: 'plain' }, (typeof child === 'string' ? { type: 'tpl', tpl: child } : child)), "body/" + index, index);
            });
        }
