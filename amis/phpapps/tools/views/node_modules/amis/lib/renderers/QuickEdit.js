...
var matches_1 = tslib_1.__importDefault(require("dom-helpers/query/matches"));
    ...
    return function (Component) {
        var QuickEditComponent = /** @class */ (function (_super) {
            ...
            QuickEditComponent.prototype.buildSchema = function () {
                ...
                if (quickEdit === true) {
                    ...
                    if ((quickEdit.controls &&
                        ...
                        quickEdit.tabs ||
                        quickEdit.fieldSet) {
                        schema = tslib_1.__assign(tslib_1.__assign({ title: '', autoFocus: quickEdit.mode !== 'inline' }, quickEdit), { mode: 'noraml', type: 'form' });
                    }
                    else {
                        schema = {
                            title: '',
                            ...
                            mode: 'normal',
                            controls: [
                                tslib_1.__assign(tslib_1.__assign({ type: quickEdit.type || 'text', name: quickEdit.name || name }, quickEdit), { mode: undefined })
                            ]
                        };
                    }
                }
            ...
            QuickEditComponent.prototype.render = function () {
                var _a = this.props, onQuickChange = _a.onQuickChange, quickEdit = _a.quickEdit, quickEditEnabled = _a.quickEditEnabled, className = _a.className, cx = _a.classnames, render = _a.render, noHoc = _a.noHoc, canAccessSuperData = _a.canAccessSuperData;
