...
var ComboControl = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, env.confirm(deleteConfirmText ? tpl_1.filter(deleteConfirmText, ctx) : __('确认要删除？'))];
                    case 1:
                        confirmed = _b.sent();
                        if (!confirmed) {
                            // 如果不确认，则跳过！
    ...
    ComboControl.prototype.handleChange = function (values, diff, _a) {
        ...
        store.forms.forEach(function (item) {
            return mobx_state_tree_1.isAlive(item) &&
                item.items.forEach(function (item) { return item.unique && item.syncOptions(); });
        });
    };
    ...
    ComboControl.prototype.validate = function () {
        ...
        if (minLength && (!Array.isArray(value) || value.length < minLength)) {
            return __((messages && messages.minLengthValidateFailed) ||
                '组合表单成员数量不够，低于设定的最小{{minLength}}个，请添加更多的成员。', { minLength: minLength });
        }
        else if (maxLength && Array.isArray(value) && value.length > maxLength) {
            return __((messages && messages.maxLengthValidateFailed) ||
                '组合表单成员数量超出，超出设定的最大{{maxLength}}个，请删除多余的成员。', { maxLength: maxLength });
        }
            ...
            return Promise.all(this.subForms.map(function (item) { return item.validate(); })).then(function (values) {
                if (~values.indexOf(false)) {
                    return __((messages && messages.validateFailed) ||
                        '子表单验证失败，请仔细检查');
                }
                return;
            });
    ...
    ComboControl.prototype.renderPlaceholder = function () {
        ...
        return react_1.default.createElement("span", { className: "text-muted" }, __(placeholder || '没有数据'));
    };
    ComboControl.prototype.renderTabsMode = function () {
        ...
        return (react_1.default.createElement(Tabs_1.default, { className: 'ComboTabs', mode: tabsStyle, activeKey: store.activeKey, onSelect: this.handleTabSelect, additionBtns: !disabled ? (react_1.default.createElement("li", { className: cx("Tabs-link ComboTabs-addLink") }, store.addable && addable !== false ? (Array.isArray(conditions) && conditions.length ? (render('add-button', {
            ...
            })) : (react_1.default.createElement("a", { onClick: this.addItem, "data-position": "left", "data-tooltip": __('新增一条数据') },
                addIcon ? react_1.default.createElement(icons_1.Icon, { icon: "plus", className: "icon" }) : null,
                react_1.default.createElement("span", null, __(addButtonText || '新增'))))) : null)) : null }, value.map(function (value, index) {
            ...
            if (finnalRemovable && // 表达式判断单条是否可删除
                ...
                toolbar = (react_1.default.createElement("a", { onClick: _this.removeItem.bind(_this, index), key: "remove", className: cx("Combo-toolbarBtn " + (!store.removable ? 'is-disabled' : '')), "data-tooltip": __('删除'), "data-position": "bottom" }, deleteIcon ? (react_1.default.createElement("i", { className: deleteIcon })) : (react_1.default.createElement(icons_1.Icon, { icon: "close", className: "icon" }))));
            }
            ...
            return (react_1.default.createElement(Tabs_1.Tab, { title: tpl_1.filter(tabsLabelTpl ||
                    __('成员{{index}}', { index: data.index + 1 }), data), key: _this.keys[index] || (_this.keys[index] = helper_1.guid()), toolbar: toolbar, eventKey: index, 
                ...
                condition && typeSwitchable !== false ? (react_1.default.createElement("div", { className: cx('Combo-itemTag') },
                    react_1.default.createElement("label", null, __('类型')),
                ...
                })) : (react_1.default.createElement(components_1.Alert2, { level: "warning", className: "m-b-none" }, __('数据非法，或者数据已失效，请移除'))))));
        })));
    };
        ...
        return (react_1.default.createElement("div", { className: cx("Combo Combo--multi", multiLine ? "Combo--ver" : "Combo--hor", noBorder ? "Combo--noBorder" : '', disabled ? 'is-disabled' : '', !disabled && draggable && Array.isArray(value) && value.length > 1
            ...
            react_1.default.createElement("div", { className: cx("Combo-items") }, Array.isArray(value) && value.length ? (value.map(function (value, index, thelist) {
                ...
                if (finnalRemovable && // 表达式判断单条是否可删除
                    (!itemRemovableOn ||
                        tpl_1.evalExpression(itemRemovableOn, value) !== false)) {
                    toolbar.push(react_1.default.createElement("a", { onClick: _this.removeItem.bind(_this, index), key: "remove", className: cx("Combo-toolbarBtn " + (!store.removable ? 'is-disabled' : '')), "data-tooltip": __('删除'), "data-position": "bottom" }, deleteIcon ? (react_1.default.createElement("i", { className: deleteIcon })) : (react_1.default.createElement(icons_1.Icon, { icon: "close", className: "icon" }))));
                }
                var data = _this.formatValue(value, index);
                var condition = null;
                if (Array.isArray(conditions) && conditions.length) {
                ...
                return (react_1.default.createElement("div", { className: cx("Combo-item"), key: _this.keys[index] || (_this.keys[index] = helper_1.guid()) },
                    !disabled && draggable && thelist.length > 1 ? (react_1.default.createElement("div", { className: cx('Combo-itemDrager') },
                        react_1.default.createElement("a", { key: "drag", "data-tooltip": __('拖拽排序'), "data-position": "bottom" }, dragIcon ? (react_1.default.createElement("i", { className: dragIcon })) : (react_1.default.createElement(icons_1.Icon, { icon: "drag-bar", className: "icon" }))))) : null,
                    condition && typeSwitchable !== false ? (react_1.default.createElement("div", { className: cx('Combo-itemTag') },
                        react_1.default.createElement("label", null, __('类型')),
                        react_1.default.createElement(Select_1.default, { onChange: _this.handleComboTypeChange.bind(_this, index), options: conditions.map(function (item) { return ({
                                label: item.label,
            ...
            !disabled ? (react_1.default.createElement("div", { className: cx("Combo-toolbar") },
                ...
                })) : (react_1.default.createElement("button", { type: "button", onClick: this.addItem, className: cx("Button Combo-addBtn", addButtonClassName), "data-tooltip": __('新增一条数据') },
                    addIcon ? react_1.default.createElement(icons_1.Icon, { icon: "plus", className: "icon" }) : null,
                    react_1.default.createElement("span", null, __(addButtonText || '新增'))))) : null,
    ...
    ComboControl.prototype.renderSingle = function () {
        ...
        var controls = this.props.controls;
        var data = helper_1.isObject(value) ? this.formatValue(value) : this.defaultValue;
        var condition = null;
        if (Array.isArray(conditions) && conditions.length) {
        ...
        return (react_1.default.createElement("div", { className: cx("Combo Combo--single", multiLine ? "Combo--ver" : "Combo--hor", noBorder ? "Combo--noBorder" : '', disabled ? 'is-disabled' : '') },
            ...
            value && nullable ? (react_1.default.createElement("a", { className: cx('Combo-setNullBtn'), href: "#", onClick: this.setNull }, __('清空数据'))) : null));
    };
