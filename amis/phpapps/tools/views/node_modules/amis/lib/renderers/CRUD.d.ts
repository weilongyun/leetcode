...
export declare type CRUDTableSchem = CRUDCommonSchema & {
    mode?: 'table';
 ...
 */
export declare type CRUDSchema = CRUDCardsSchema | CRUDListSchema | CRUDTableSchem;
...
export default class CRUD extends React.Component<CRUDProps, any> {
    ...
    handleSave(rows: Array<object> | object, diff: Array<object> | object, indexes: Array<number>, unModifiedItems?: Array<any>, rowsOrigin?: Array<object> | object, resetOnFailed?: boolean): void;
