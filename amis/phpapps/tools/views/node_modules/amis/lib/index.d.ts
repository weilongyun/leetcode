 ...
 */
import { render, Renderer, getRendererByName, registerRenderer, unRegisterRenderer, resolveRenderer, filterSchema, clearStoresCache, updateEnv } from './factory';
...
export { render, clearStoresCache, updateEnv, Renderer, RegisterStore, FormItem, OptionsControl, wrapFetcher, buildApi, filter, utils, resizeSensor, registerFilter, registerTplEnginer, evalExpression, evalJS, setCustomEvalJs, setCustomEvalExpression, addRule, str2rules, normalizeOptions, getRendererByName, registerRenderer, unRegisterRenderer, registerFormItem, registerOptionsControl, resolveRenderer, filterSchema, filterDate, relativeValueRe, resolveVariable, resolveVariableAndFilter, setIconVendor, Icon, registerIcon, Scoped, ScopedContext, validate, validateObject, setDefaultTheme, theme, getTheme, classPrefix, getClassPrefix, classnames, getDefaultLocale, setDefaultLocale, registerLocale, makeTranslator, animation };
