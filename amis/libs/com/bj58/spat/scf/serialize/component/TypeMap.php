...
class TypeMap {
   public static function init() {
       ...
       if (apcu_exists('SCFTypeIdMap')) {
           $SCFTypeIdMap = @apcu_fetch('SCFTypeIdMap');
       } else {
           $SCFTypeIdMap = array(
               1 => "DBNull",
               2 => "Object",
       ...
       if (apcu_exists('SCFIdTypeMap')) {
           $SCFIdTypeMap = @apcu_fetch('SCFIdTypeMap');
       } else {
           $SCFIdTypeMap = array(
               "DBNull" => 1,
               "Object" => 2,
