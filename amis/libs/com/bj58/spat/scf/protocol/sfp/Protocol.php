...
class Protocol
{
    ...
    public static function fromBytes($data)
    {
        try {
            ...
            switch ($version[1]) {
                case '1':
                    return ProtocolHelper::getInstance()->pV1FromBytes($data);
                case '2':
                    return ProtocolHelper::getInstance()->pV2FromBytes($data);
                default:
     ...
     * @throws Exception
     */
    public static function toBytes($p)
    {
        try {
            switch ($p->getVERSION()) {
                case 1:
                    return ProtocolHelper::getInstance()->pV1ToBytes($p);
                case 2:
                    return ProtocolHelper::getInstance()->pV2ToBytes($p);
                default:
