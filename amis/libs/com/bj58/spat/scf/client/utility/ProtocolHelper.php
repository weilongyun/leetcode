...
{
  public static function createProtocol($requestProtocol, $sessionId, $serviceName, $keyPath)
  {
      try {
          ...
          if (null !== $config) {
              ...
              $sendP = new Protocol($sessionId, $config['id'], SDPType::Request,
                  CompressType::UnCompress, $serializerType, PlatformType::Java, $requestProtocol);
              $sendP->setKey(KeyLoad::getKeyContent($keyPath, $serviceName));
