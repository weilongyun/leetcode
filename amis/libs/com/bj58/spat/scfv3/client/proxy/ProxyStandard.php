...
class ProxyStandard
{
    ...
    {
        TypeMap::init($serviceName);
        $this->lookup = $lookup;
        $this->serviceName = $serviceName;
        $this->initObj = $initObj;
    }

    public function invoke($methodName, $param, $SerGlobal = false)
    {
        try {
            ...
            $obj = MethodCaller::doMethodCall($param, $methodName, $this->serviceName, $this->lookup, $this->initObj, $SerGlobal);
 ...
 /**
    ...
    public function setInitObj($initObj)
    {
        $this->initObj = $initObj;
        return $this;
    }
