...
class DispCategoryExt{
	 static $_TSPEC;
	 static $_SCFNAME = 'DispCategoryExt';
	...
	private $InfoCateidList;
	 ...
	 public function __construct($DispCategoryID = '', $PID = '', $CateName = '', $DispCategoryGroup = '', $Depth = '', $FullPath = '', $Order = '', $CateID = '', $Filter = '', $ListName = '', $System = '', $Type = '', $IsVisible = '', $CateidList = '', $BusinessType = '', $Conditions = '', $DispBiz = '', $Base = '', $InfoCateidList = '' ) {
	...
	{
		 return DispCategoryExt::$_TSPEC;
	}
	 public static function setTSPEC($_TSPEC)
	{
		DispCategoryExt::$_TSPEC = $_TSPEC;
	}
