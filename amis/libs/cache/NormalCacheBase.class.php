...
class NormalCacheBase extends \Libs\Cache\MemcacheBase{
    ...
    private static $NormalCacheBaseObj = array();
    private $timeout = 600;
    ...
    static public function instance() {
        ...
        if(!isset(self::$NormalCacheBaseObj[$className])) {
            self::$NormalCacheBaseObj[$className] = new self(static::PREFIX);
            self::$NormalCacheBaseObj[$className]->setTime(static::TIMEOUT);
        }       
        return self::$NormalCacheBaseObj[$className];
    }
}
