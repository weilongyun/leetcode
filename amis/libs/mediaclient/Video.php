...
class Video
{
        ...
        $bizAttr = null, $title = null, $desc = null, $magicContext = null)
    {
        ...
        $sign = Auth::appSign($expired, $bucketName, MediaClient::VIDEO_TYPE);
        ...
        $sliceSize = self::DEFAULT_SLICE_SIZE, $session = null)
    {
        ...
        if ($fileSize < self::MIN_SLICE_FILE_SIZE) {
            return self::upload($srcPath, $bucketName, $dstPath, $videoCover, $bizAttr);
        }
        ...
        $ret = self::upload_prepare($fileSize, $sha1, $sliceSize,
        ...
        if ($sliceSize > self::DEFAULT_SLICE_SIZE || $sliceSize <= 0) {
        ...
        $ret = self::upload_data($fileSize, $sha1, $sliceSize,
            $sign, $url, $srcPath, $offset, $session);
        return $ret;
    }

    private static function upload_prepare(
        $fileSize, $sha1, $sliceSize, $sign, $url, $bizAttr, $videoCover = null,
        $title = null, $desc = null, $magicContext = null, $session = null)
    {
        $data = array(
            'op' => 'upload_slice',
            'filesize' => $fileSize,
    ...
    private static function generateSliceBody($fileContent, $offset, $sha, $session, $fileName, $boundary)
    {
        $formdata = '';
        ...
        $pattern = 'eListBoth', $order = 0, $context = null)
    {
        ...
        return self::listBase($bucketName, $prefix, $num, $pattern, $order, $context);
    }
