...
class Cosapi
{
    ...
    public static function upload($srcPath, $bucketName, $dstPath, $bizAttr = null)
    {
        ...
        $sign = Auth::appSign($expired, $bucketName, MediaClient::AUDIO_TYPE);
    ...
    public static function upload_slice(
        ...
        $bizAttr = null, $sliceSize = 0, $session = null)
    {
        $srcPath = realpath($srcPath);
        ...
        if ($fileSize < self::MIN_SLICE_FILE_SIZE) {
            return self::upload($srcPath, $bucketName, $dstPath, $bizAttr);
        }
        ...
        $ret = self::upload_prepare($fileSize, $sha1, $sliceSize, $sign, $url, $bizAttr, $session);
    ...
    private static function upload_data(
        $fileSize, $sha1, $sliceSize, $sign,
        $url, $srcPath, $offset, $session)
    {
