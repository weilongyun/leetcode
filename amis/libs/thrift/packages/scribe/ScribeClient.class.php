...
class ScribeClient extends \Thrift\Packages\Fb303\FacebookServiceClient implements \Thrift\Packages\Scribe\ScribeIf {
  ...
  {
    $args = new \Thrift\Packages\Scribe\Scribe_Log_args();
  ...
  public function recv_Log()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Thrift\Packages\Scribe\Scribe_Log_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Thrift\Packages\Scribe\Scribe_Log_result();
