...
class TExecuteStatementResp extends TBase {
  static $_TSPEC;
  ...
  {
    return $this->_read('TExecuteStatementResp', self::$_TSPEC, $input);
  }

  public function write($output) {
    return $this->_write('TExecuteStatementResp', self::$_TSPEC, $output);
  }
