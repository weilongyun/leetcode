...
include "../share/fb303/fb303.thrift"

namespace php Thrift.Packages.HiveMetaStore
...
service ThriftHiveMetastore extends fb303.FacebookService
{
  ...
  void create_function(1:MSFunction func)
      throws (1:AlreadyExistsException o1,
  ...
  void alter_function(1:string dbName, 2:string funcName, 3:MSFunction newFunc)
      throws (1:InvalidOperationException o1, 2:MetaException o2)

  list<string> get_functions(1:string dbName, 2:string pattern)
      throws (1:MetaException o1)
  MSFunction get_function(1:string dbName, 2:string funcName)
      throws (1:MetaException o1, 2:NoSuchObjectException o2)
